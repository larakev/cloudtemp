...
<html lang="es">
  ...
  <body>
    ...
    <?php
      ...
      $id = $_GET['id'];
      $query = "SELECT usuario, nombre, apellidos, email, telefono, password FROM usuarios WHERE id = '$id'";
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Usuario:</label>
                    <input type="text" name="usuario" placeholder="<?php echo $row ['usuario']; ?>" class="form-control" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Email:</label>
                    <input type="email" name="email" placeholder="<?php echo $row ['email']; ?>" class="form-control" >
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Nombre:</label>
                    <input type="text" name="nombre" placeholder="<?php echo $row ['nombre']; ?>" class="form-control" >
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Apellido:</label>
                    <input type="text" name="apellidos" placeholder="<?php echo $row ['apellidos']; ?>" class="form-control" >
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="telefono" placeholder="<?php echo $row ['telefono']; ?>" class="form-control" >
                    <button type="submit" name="enviar" class="submit btn btn-primary">Guardar</button>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
