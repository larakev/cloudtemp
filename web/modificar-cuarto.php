...
<html lang="es">
  ...
  <body>
    ...
    <?php
      ...
      $id = $_GET['id'];
      $query = "SELECT nombre, encargado, dimenciones, ubicacion, tempmaxima, tempminima, descripcion FROM cuartos WHERE id = '$id'";
      ...
      <div class="row">
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Modificar Cuarto</h3>
          </div>
          <div class="panel-body">
            <form method="post" action="../accion/accion_mod_usuario.php">
              <div class="row">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="NombreCuarto">Nombre del Cuarto:</label>
                    <input type="text" name="nombre" placeholder="<?php echo $row ['nombre']; ?>" class="form-control" id="NombreCuarto" required autofocus>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="Encargado">Encargado:</label>
                    <input type="text" name="encargado" placeholder="<?php echo $row ['encargado']; ?>" class="form-control" id="Encargado" required>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="dimenciones" placeholder="<?php echo $row ['dimenciones']; ?>" class="form-control" id="Dimenciones" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="Ubicacion">Ubicación:</label>
                    <input type="text" name="ubicacion" placeholder="<?php echo $row ['ubicacion']; ?>" class="form-control" id="Ubicacion" required>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="tempmaxima" placeholder="<?php echo $row ['tempmaxima']; ?>" class="form-control" id="TempMaxima" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="TempMinima">Temperatura Mínima:</label>
                    <input type="text" name="tempminima" placeholder="<?php echo $row ['tempminima']; ?>" class="form-control" id="TempMinima" required>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea class="form-control" name="descripcion" placeholder="<?php echo $row ['descripcion']; ?>" id ="Descripcion"></textarea>
