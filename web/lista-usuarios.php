  ...
  <body>
    ...
    <!-- Contenido Aquí -->
     ...
     <?php
      ...
      $resul_user = mysql_query($query_user);
    ...
    <h3 class="titulo-tabla">Lista de Usuarios</h3>
		<table class="table">
          ...
          <tbody>
          	<?php while ($row=mysql_fetch_array($resul_user)){ ?>
                <tr>
                  ...
                  <td><center>
                    <a class="icono_mod btn btn-default" href="../web/modificar-usuario.php?id=<?php echo $row['id']?>">
                      <span class="glyphicon glyphicon-pencil ico" aria-hidden="true"></span>
                    </a>
                    <a class="icono_del btn btn-default" href="../accion/accion_del_usuario.php?id=<?php echo $row['id']?>">
